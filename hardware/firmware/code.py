...
# PWM-driven LEDs for smooth fade animations. GP25 is the Pico's onboard LED
# pin — CircuitPython may have already claimed the PWM slice for its own status
# indicator. Fall back to plain digital on/off so the firmware always starts
# even when PWM init fails.
try:
